...
def render(output, cards_per_row=7, examples=5, scale=2, resolution=32):
    ...
    draw.text(
        (outer, outer + 36),
        f"{N_LEVELS} niveles · {examples} ejemplos deterministas por nivel · "
        f"RGB nativo {resolution}×{resolution}",
        fill=(157, 170, 191),
        font=subtitle_font,
    )
